...
enum returnCode { STATUS_BUFFER_OVERFLOW = -3, STATUS_TIMEOUT = -2, STATUS_FAILURE = -1, STATUS_SUCCESS = 0 };
...
extern void MutexInit(MqttMutex*);
extern int MutexLock(MqttMutex*);
extern int MutexUnlock(MqttMutex*);
 ...
 * @param
 */
void MQTTClientInit(MQTTClient* client, MqttNetwork* network, unsigned int command_timeout_ms,
 ...
 *  @return success code
 */
int MQTTConnectWithResults(MQTTClient* client, MQTTPacket_connectData* options,
 ...
 *  @return success code
 */
int MQTTSubscribeWithResults(MQTTClient* client, const char* topicFilter, enum QoS, messageHandler, MQTTSubackData* data);
...
void MQTTCheckIncomingPacket(MQTTClient*, MqttTimer*);
